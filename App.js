    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem} onPress={() => onChangeScreen("Home")}>
          <MaterialCommunityIcons name="bed-king-outline" size={24} color="#fff" />
          <Text style={[styles.navText, activeScreen === "Home" && styles.activeNavText]}>
            Rooms
          </Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => onChangeScreen("FoodMenu")}>
          <Ionicons name="restaurant-outline" size={24} color="#fff" />
          <Text style={[styles.navText, activeScreen === "FoodMenu" && styles.activeNavText]}>
            Food Menu
          </Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => onChangeScreen("Request")}>
          <Feather name="edit" size={22} color="#fff" />
          <Text style={[styles.navText, activeScreen === "Request" && styles.activeNavText]}>
            Request
          </Text>
        </TouchableOpacity>
      </View>
